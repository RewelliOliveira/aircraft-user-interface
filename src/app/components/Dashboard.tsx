...
export function Dashboard() {
  ...
  // Recarregar dados quando um evento SSE ocorrer
  useSSE(() => fetchData());
  ...
  return (
    <div className="min-h-screen pt-14" style={{ background: "#070d1a" }}>
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(0,200,248,0.06) 0%, transparent 60%), radial-gradient(ellipse 60% 40% at 90% 80%, rgba(124,58,237,0.05) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 mb-3">
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: "#00c8f8", letterSpacing: "0.2em" }}>
              AIRCRAFT API // DASHBOARD
            </span>
          </div>
          <h1 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "38px", fontWeight: 700, color: "#e8edf5", lineHeight: 1.15 }}>
            Fleet Intelligence<br />
            <span style={{ color: "#00c8f8" }}>Monitor</span>
          </h1>
          <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "15px", color: "#6b7fa3", marginTop: "10px" }}>
          ...
          {[
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "9px", color: "#6b7fa3", letterSpacing: "0.15em" }}>
                  {kpi.label}
                </span>
                <div style={{ color: kpi.color, opacity: 0.6 }}>{kpi.icon}</div>
              </div>
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "32px", fontWeight: 700, color: kpi.color, lineHeight: 1 }}>
                {kpi.value}
              </p>
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "11px", color: "#4a5568", marginTop: "6px" }}>
                {kpi.sub}
              </p>
            </div>
          ))}
        ...
        {/* Main grid: airlines + chart */}
        <div className="grid grid-cols-3 gap-6">
          {/* Airlines list — 2/3 width */}
          <div className="col-span-2">
            {/* Search */}
            <div
              className="flex items-center gap-2 px-4 mb-4 rounded-lg"
              style={{ background: "rgba(15,30,54,0.9)", border: "1px solid rgba(0,200,248,0.12)", height: "42px" }}
            >
              ...
              {filtered.map((airline) => {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLElement).style.borderColor = "rgba(0,200,248,0.25)";
                    }}
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLElement).style.borderColor = "rgba(0,200,248,0.08)";
                    }}
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span style={{ color: "rgba(0,200,248,0.15)" }}>·</span>
                          <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: "#4a5568" }}>
                      ...
                      <div className="flex items-center gap-4 flex-shrink-0">
                        <div className="text-right">
                          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "20px", fontWeight: 700, color: "#00c8f8", lineHeight: 1 }}>
                            {fleetCount}
                          </p>
          ...
          <div className="space-y-4">
            ...
            <div
              className="rounded-xl p-5"
              style={{ background: "rgba(13,22,40,0.8)", border: "1px solid rgba(0,200,248,0.1)" }}
            >
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: "#6b7fa3", letterSpacing: "0.12em", marginBottom: "16px" }}>
                FROTA POR COMPANHIA
              </p>
              <ResponsiveContainer width="100%" height={160}>
                <BarChart data={fleetByAirline} barSize={20}>
                  <XAxis
                    dataKey="name"
                    tick={{ fill: "#6b7fa3", fontSize: 10, fontFamily: "JetBrains Mono" }}
                    axisLine={false}
                    tickLine={false}
                  />
                  <Tooltip
                  ...
                  />
                  <Bar dataKey="total" fill="#00c8f8" radius={[3, 3, 0, 0]} opacity={0.8} />
                </BarChart>
              </ResponsiveContainer>
            </div>
            ...
            <div
              ...
              style={{ background: "rgba(13,22,40,0.8)", border: "1px solid rgba(0,200,248,0.1)" }}
            >
              <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: "#6b7fa3", letterSpacing: "0.12em", marginBottom: "12px" }}>
              ...
              {[
                ...
                { method: "GET", path: "/aircraft/{prefixo}", color: "#10b981" },
                ...
                >
                  ...
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", color: "#6b7fa3" }}>
                    {ep.path}
                  </span>
                </div>
              ))}
            ...
            >
              ...
              {[
                { label: "Passageiros", count: totalPassenger, pct: Math.round((totalPassenger / totalFleet) * 100), color: "#00c8f8" },
                { label: "Carga", count: totalCargo, pct: Math.round((totalCargo / totalFleet) * 100), color: "#a855f7" },
              ].map((t) => (
                <div key={t.label} className="mb-3">
                  <div className="flex justify-between items-center mb-1">
                    <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: "12px", color: "#c4cdd8" }}>{t.label}</span>
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", color: t.color }}>{t.count}</span>
                  </div>
                  <div className="h-1.5 rounded-full" style={{ background: "rgba(255,255,255,0.05)" }}>
                    <div className="h-full rounded-full" style={{ width: `${t.pct}%`, background: t.color, opacity: 0.8 }} />
                  </div>
                </div>
              ))}
            </div>
