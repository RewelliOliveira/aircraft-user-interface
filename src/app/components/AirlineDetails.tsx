...
export function AirlineDetails() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // O backend já traz a frota no objeto da companhia, mas podemos buscar separadamente se preferir
  ...
  if (!airline) return <div className="pt-20 text-center text-muted-foreground">Companhia não encontrada.</div>;
  ...
  return (
    <div className="min-h-screen pt-14" style={{ background: "#070d1a" }}>
      ...
      <div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(13,22,40,0.98) 0%, rgba(7,13,26,1) 100%)",
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-10">
          <button
            ...
            style={{ fontFamily: "'Outfit', sans-serif", fontSize: "13px", color: "#6b7fa3" }}
          >
            <ArrowLeft size={14} />
            Voltar ao Dashboard
          </button>
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "14px", color: "#6b7fa3", maxWidth: "560px", lineHeight: 1.6 }}>
                Companhia aérea operando em {airline.pais}. Fundada em {airline.ano_fundacao}.
              </p>
            </div>
            ...
            <div className="flex gap-3 flex-shrink-0">
              {[
                ...
                >
                  ...
                  <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "9px", color: "#6b7fa3", letterSpacing: "0.1em", marginTop: "2px" }}>
                    {s.label}
                  </p>
                </div>
              ))}
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex gap-3 mb-6">
          <div
            ...
            style={{ background: "rgba(0,200,248,0.06)", border: "1px solid rgba(0,200,248,0.15)" }}
          >
            <Users size={13} style={{ color: "#00c8f8" }} />
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", color: "#00c8f8" }}>
          ...
          >
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "11px", color: "#a855f7" }}>
              {carga} CARGA
            </span>
          </div>
        </div>
        ...
        <div className="flex gap-3 mb-6">
          <div
            ...
            style={{ background: "rgba(15,30,54,0.8)", border: "1px solid rgba(0,200,248,0.12)", height: "40px" }}
          >
        ...
        <div
          ...
          style={{ border: "1px solid rgba(0,200,248,0.1)", background: "rgba(13,22,40,0.6)" }}
        >
          <div
          ...
          {filtered.length === 0 ? (
            <div className="py-12 text-center">
              <Plane size={32} style={{ color: "#0f1e36", margin: "0 auto 12px" }} />
              <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: "14px", color: "#6b7fa3" }}>Nenhuma aeronave encontrada</p>
            </div>
          ) : (
            filtered.map((ac, idx) => {
              ...
              return (
                <div
                  ...
                  onClick={() => {
                    ...
                    toast.info(`Carregando dados de ${ac.prefixo}`, { duration: 1500 });
                  }}
                >
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "13px", fontWeight: 600, color: isCargo ? "#a855f7" : "#00c8f8", letterSpacing: "0.05em" }}>
                    {ac.prefixo}
                  </span>
                  <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: "13px", color: "#c4cdd8" }}>
                    {ac.modelo}
                  </span>
                  <div
                    className="flex items-center gap-1.5 w-fit px-2 py-0.5 rounded"
                    style={{
                      background: isCargo ? "rgba(124,58,237,0.1)" : "rgba(0,200,248,0.08)",
                      border: `1px solid ${isCargo ? "rgba(124,58,237,0.2)" : "rgba(0,200,248,0.15)"}`,
                    }}
                  >
                    {isCargo ? <Package size={10} style={{ color: "#a855f7" }} /> : <Users size={10} style={{ color: "#00c8f8" }} />}
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: isCargo ? "#a855f7" : "#00c8f8" }}>
                      {isCargo ? "CARGO" : "PAX"}
                    </span>
                  </div>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "13px", color: "#c4cdd8" }}>
                    {isCargo ? `${ac.capacidade_carga_kg || 0}kg` : ac.num_assentos || 0}
                  </span>
        ...
        <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "10px", color: "#4a5568", marginTop: "12px", letterSpacing: "0.05em" }}>
          {filtered.length} aeronave{filtered.length !== 1 ? "s" : ""} exibida{filtered.length !== 1 ? "s" : ""} · Clique para ver detalhes
        </p>
      </div>

      {selectedAircraft && (
        <AircraftCard aircraft={selectedAircraft} onClose={() => setSelectedAircraft(null)} />
      )}
    </div>
  );
}
